    ...
    <Fragment>
      <div className="order">
        <div className="order-header">
          <h1>Order</h1>
          <p>
            Order one of our afternoon tea boxes to be delivered straight to
            your door!
          </p>
        </div>
        <br></br>
        <div className="order-content">
          <p>
            We currently have three of our afternoon tea boxes available to
            order for home delivery. Scroll for more information and to submit
            an order.
          </p>
          <br></br>
          <div className="tea-options-container">
            <div className="tea-options">
              ...
              <p>
                ...
                aliqua. At quis risus sed vulputate. Lorem mollis aliquam ut
            ...
            <form action="">
              ...
              <div className="order-form-row">
                <input
                  ...
                  value="Sherlock"
                />
                <label htmlFor="vehicle1">Sherlock Holmes Tea</label>
                <br></br>
                <input type="checkbox" id="tltea" name="tltea" value="Time" />
                <label htmlFor="vehicle2">Time Lord Tea</label>
                <br></br>
                <input type="checkbox" id="fwtea" name="fwtea" value="Fairy" />
                <label htmlFor="vehicle3">Fairy Tale Woodland Tea</label>
              </div>
              <br></br>
              <div className="order-form-row">
                <textarea
